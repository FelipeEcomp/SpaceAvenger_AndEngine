...
public class PlayerMovements extends SimpleBaseGameActivity {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	public void onBackPressed() {  //botão voltar
		Intent telacad = new Intent(PlayerMovements.this,StageSelection.class);
		PlayerMovements.this.startActivity(telacad);    		
		PlayerMovements.this.finish(); 
